...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<CartViewModel>.reactive(
      viewModelBuilder:
          () => CartViewModel(productManager: context.read<ProductManager>()),
      onViewModelReady: (model) {
        model.futureToRun();
        model
          ..productsList.onChange.listen((list) => products = list.neu)
          ..total.onChange.listen((event) => total = event.neu);
      },
      builder:
                                  ...
                                  child: CartItem(
                                    ...
                                    onHold: () {
                                      DefaultDialog(
                                        ...
                                        message:
                                            'O item será deletado do carrinho',
                                        buttonTitle: 'Confirmar',
                                        primaryButtonDestructive: true,
                                      ).showDefaultDialog();
                                    },
